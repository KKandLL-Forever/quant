...
## 数据
- 个股后复权收盘:本地 DuckDB `daily.close*adj_factor`。
- 基准 588000:tushare `fund_daily + fund_adj`(在线;`--no-bench` 可跳过)。
...
|---|---|---|---|---|---|
| 龙头动量轮动策略 | 107.3% | 42.0% | 19.0% | 2.56 | 5.66 |
| 等权重组合 | 78.9% | 28.3% | 16.0% | 2.79 | 4.94 |
